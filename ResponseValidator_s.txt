...
// ====================================================================
// ⚠️ VERSIONE SANITIZZATA: Sostituire "Your Parish Name" con nome reale
// ====================================================================
...
class ResponseValidator {
  constructor() {
    ...
    // ⚠️ SOSTITUIRE con nome parrocchia reale
    this.signaturePattern = /segreteria\s+parrocchia\s+your[\s-]?parish[\s-]?name/i;
  ...
  _checkSignature(response, salutationMode = 'full') {
    ...
    if (!this.signaturePattern.test(response)) {
      warnings.push("Missing signature 'Segreteria Parrocchia Your Parish Name'");
      score = 0.95;
    }
