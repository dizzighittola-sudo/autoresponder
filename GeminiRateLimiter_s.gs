...
class GeminiRateLimiter {
  ...
  _initializeCounters() {
    // ✅ FIX BUG #3: Usa ScriptLock per sincronizzare il reset tra esecuzioni parallele
    ...
    try {
      ...
      if (lock.tryLock(5000)) {
        ...
        console.warn('⚠️ Could not acquire lock for quota reset initialization, skipping check');
      }
    } catch (e) {
